...
Efficient shortest-path computation on large graphs underpins all such methods; Dijkstra's algorithm \cite{dijkstra1959} and its engineered variants, including contraction hierarchies \cite{geisberger2008} and landmark-based acceleration \cite{bast2016}, are the standard foundation.
